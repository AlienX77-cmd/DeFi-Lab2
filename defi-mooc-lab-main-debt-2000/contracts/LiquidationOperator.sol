...
contract LiquidationOperator is IUniswapV2Callee {
    ...
    constructor() {
        ...
        uniswapV2Pair_WBTC_USDT = IUniswapV2Pair(uniswapV2Factory.getPair(address(WBTC), address(USDT))); // Pool1 สำหรับ Flash Loan
        uniswapV2Pair_WBTC_WETH = IUniswapV2Pair(uniswapV2Factory.getPair(address(WBTC), address(WETH))); // Pool2 สำหรับการ Swap จาก WBTC ไปเป็น WETH
        debt_USDT = 2000000000; //2,000.000000

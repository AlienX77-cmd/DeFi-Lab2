...
contract LiquidationOperator is IUniswapV2Callee {
    ...
    IUniswapV2Pair immutable uniswapV2Pair_WETH_USDC; // Pool1 สำหรับการ Flash Loan (กู้ USDT และชำระคืนด้วย WETH)
    ...
    constructor() {
        ...
        uniswapV2Pair_WETH_USDC = IUniswapV2Pair(uniswapV2Factory.getPair(address(WETH), address(USDC))); // Pool1 สำหรับ Flash Loan

        debt_USDC = 8128956343; //8,128.956343
    ...
    function operate() external {
        ...
        uniswapV2Pair_WETH_USDC.swap(debt_USDC, 0, address(this), "$"); //Flash Loan Operation
    ...
    function uniswapV2Call(
        ...
        (uint256 reserve_USDC_Pool1, uint256 reserve_WETH_Pool1, ) = uniswapV2Pair_WETH_USDC.getReserves(); // Pool1 สำหรับ Flash Loan
        ...
        console.log("Flash Loan USDC: %s", USDC.balanceOf(address(this))); //Check ว่ามีเงิน USDT จาก Flash Loan
        ...
        console.log("collateral_WETH: %s", WETH.balanceOf(address(this)));
        ...
        console.log("After Repayment, WETH: %s", WETH.balanceOf(address(this)));
